...
class BlenderTranscoder(ITranscoder):
    options = [IntVectorOption(name='size', description='The target size of the image', size=2, min=1, max=4096, default=(128,128)),
               IntOption(name='pages', description='Total number of frames.', min=1, max=4096, default=1),]
    convert_map = {"application/x-blender.text" : {"image/jpg": options, "image/png": options},}
